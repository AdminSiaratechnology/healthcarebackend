...
class ImagingCenter(Document, AutoEncryptMixin, AutoDecryptMixin):
    ...
    # 🔐 Encrypted
    center_name: Binary | None = None
    phone: Binary | None = None
    fax: Binary | None = None
    turnaround_time: Binary | None = None
    transport_notes: Binary | None = None
    
    # 🟢 Searchable (NON-PHI)
    center_name_search: Annotated[str | None, Indexed()] = None
    ...
    class Settings:
        name = "imaging_centers"
        indexes = [
            [("facility_id.$id", 1), ("center_name_search", 1)],
